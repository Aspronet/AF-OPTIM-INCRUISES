  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6">
      <div className="max-w-2xl w-full text-center">
        <p className="text-sm text-gray-500 mb-4">Paso 7 de 8</p>
        <h1 className="text-4xl font-bold mb-6">Step 7</h1>
        <p className="text-gray-600 mb-8">Contenido del paso 7</p>
